import { S as Selection, r as root$1, c as creator, a as array$5, d as dispatch, R as Rgb, b as rgbConvert, e as define, f as extend, C as Color, g as brighter, h as darker, i as constant$a, j as interpolateNumber, k as color, l as interpolateRgb, m as interpolateString, n as hue$1, o as hsl$2, p as nogamma, q as now, T as Timer, s as SCHEDULED, t as Transition, u as interrupt, v as timer, w as rgbBasis, x as rgb, y as identity$8, z as Transform } from './kernel-b423335b.js';
export { A as easeCubic, B as easeCubicIn, A as easeCubicInOut, D as easeCubicOut, E as interpolateBasis, F as interpolateBasisClosed, I as interpolateRgbBasisClosed, G as interpolateTransformCss, H as interpolateTransformSvg, J as matcher, K as namespace, L as namespaces, M as selection, N as selector, O as selectorAll, P as style, V as timeout, U as timerFlush, W as transition, Q as window, X as zoomTransform } from './kernel-b423335b.js';
...
function bisector(f) {
  ...
  if (f.length !== 2) {
    ...
    compare1 = f === ascending$2 || f === descending$2 ? f : zero;
    compare2 = f;
    delta = f;
  }
...
function bin() {
  ...
  histogram.thresholds = function(_) {
    return arguments.length ? (threshold = typeof _ === "function" ? _ : constant$9(Array.isArray(_) ? slice$3.call(_) : _), histogram) : threshold;
  };
...
function rank(values, valueof = ascending$2) {
  ...
  values.sort(valueof === ascending$2 ? (i, j) => ascendingDefined(V[i], V[j]) : compareDefined(compareIndex));
  values.forEach((j, i) => {
...
function selectAll(selector) {
  return typeof selector === "string"
      ...
      : new Selection([array$5(selector)], root$1);
}
